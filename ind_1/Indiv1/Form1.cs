...
namespace Indiv1
{
    public partial class Form1 : Form
    {
        ...
        public void drawHull() 
        {
            ...
            {
                g.DrawLine(Pens.Blue, convexHull[i], convexHull[i + 1]);
            }
            g.DrawLine(Pens.Blue, convexHull[convexHull.Count()-1], convexHull[0]);
        }
        ...
        public void drawPoints() 
        {
            for (int i = 0; i < points.Count(); i++)
            {
                g.DrawEllipse(Pens.Red, points[i].X - 3, points[i].Y - 3, 7, 7);
            }
        }
